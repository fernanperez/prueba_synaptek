    ...
    <nav class="navbar navbar-toggleable-md navbar-light bg-white fixed-top mediumnavigation">
        ...
        <div class="container">
            ...
            <a class="navbar-brand" href="{{ route('homepage') }}">
                <img src="{{ asset('img/logo-dentos.png') }}" width="180px" alt="logo">
            </a>
            <!-- End Logo -->
            <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
                <a href="{{ route('dashboard') }}" class="btn btn-outline-primary">Acceder</a>
            </div>
        </div>
    </nav>
    <!-- End Nav
...
================================================== -->
 ...
 ================================================== -->
        <section class="recent-posts">
            ...
            <div class="card-columns listrecent">
                @forelse ($apiBlogs as $apiBlog)

                    <!-- begin post -->
                    <div class="card">
                        <div class="card-block">
                            <h2 class="card-title"><a href="#">{{ $apiBlog->title }}</a></h2>
                            <h4 class="card-text">{{ $apiBlog->body }}</h4>
                            <div class="metafooter">
                                <div class="wrapfooter">
                                    <span class="meta-footer-thumb">
                                    ...
                                    <span class="author-meta">
                                        <span class="post-name"><a
                                                href="author.html">{{ $apiBlog->userId }}</a></span><br />
                ...
                @empty
                    <div class="container">
                        <p>No hay registro de publicaciones</p>
                    </div>
                @endforelse

            </div>
            <div class="d-flex mt-5 justify-content-center">
                <div>{{ $apiBlogs->links() }}</div>
            </div>
        </section>
        <!-- End List Posts
        ================================================== -->
