        ...
        [
            ...
            function(module, exports, __webpack_require__) {
                ...
                function expandConfig(container, userConfig) {
                    ...
                    userConfig = (0, _extend2.default)(
                        true, {},
                        Quill.DEFAULTS, { modules: moduleConfig },
                        themeConfig,
                        userConfig
                    );
                ...
                function modify(modifier, source, index, shift) {
                    ...
                    if (change.length() > 0) {
                        ...
                        (_emitter = this.emitter).emit.apply(
                            _emitter, [_emitter4.default.events.EDITOR_CHANGE].concat(args)
                        );
                        if (source !== _emitter4.default.sources.SILENT) {
                            var _emitter2;
                        ...
                        },
                        {
                            ...
                            value: function normalizedToRange(range) {
                                ...
                                var start = Math.min.apply(
                                    Math, [end].concat(_toConsumableArray(indexes))
                                );
                ...
                var Keyboard = (function(_Module) {
                    ...
                    function Keyboard(quill, options) {
                        ...
                        if (/Firefox/i.test(navigator.userAgent)) {
                            ...
                            _this.addBinding({ key: Keyboard.keys.BACKSPACE }, { collapsed: true },
                                handleBackspace
                            );
                            _this.addBinding({ key: Keyboard.keys.DELETE }, { collapsed: true },
                                handleDelete
                            );
                        } else {
                        ...
                        _this.addBinding({ key: Keyboard.keys.BACKSPACE }, { collapsed: false },
                            handleDeleteRange
                        );
                        _this.addBinding({ key: Keyboard.keys.DELETE }, { collapsed: false },
                            handleDeleteRange
                        );
                        _this.addBinding({
                ...
                var History = (function(_Module) {
                    ...
                    function History(quill, options) {
                        ...
                        if (/Win/i.test(navigator.platform)) {
                            _this.quill.keyboard.addBinding({ key: "Y", shortKey: true },
                                _this.redo.bind(_this)
                            );
                        }
                        return _this;
            ...
            function(module, exports) {
                ...
                EventEmitter.prototype.removeListener = function removeListener(
                    ...
                    if (listeners.fn) {
                        ...
                        for (
                            var i = 0, events = [], length = listeners.length; i < length; i++
                        ) {
                            if (
                                listeners[i].fn !== fn ||
            ...
            function(module, exports, __webpack_require__) {
                ...
                function deltaEndsWith(delta, text) {
                    var endText = "";
                    for (
                        var i = delta.ops.length - 1; i >= 0 && endText.length < text.length;
                        --i
                    ) {
                        var op = delta.ops[i];
            ...
            function(module, exports, __webpack_require__) {
                ...
                SnowTooltip.TEMPLATE = [
                    ...
                    '<input type="text" data-formula="e=mc^2" data-link="https://quilljs.com" data-video="Insertar URL">',
                    '<a class="ql-action"></a>',
                    '<a class="ql-remove"></a>',
                ].join("");
